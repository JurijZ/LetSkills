...
{
    [Route("[controller]")]
    public class GetProviderDetailsController : Controller
    {

        private readonly SkillsContext _context;

        public GetProviderDetailsController(SkillsContext context)
        {
            _context = context;
        }
        ...
        public ProviderDetails Get(int provider_id)
        {
            ...
            Console.WriteLine("-- GetProviderDetails for Provider ID: " + provider_id);
